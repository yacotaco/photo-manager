    ...
    public void mouseClicked(MouseEvent event) {
      ...
      if (SwingUtilities.isLeftMouseButton(event) && event.getClickCount() == 2) {
        ...
        if (value != null) {
          ...
          int result = JOptionPane.showConfirmDialog(null, view.getEditDialog(), "Edit", JOptionPane.OK_CANCEL_OPTION,
  ...
  public class SearchActionListener implements ActionListener {
    ...
    public void actionPerformed(ActionEvent event) {
      if (imageList.size() == 0) {
        ...
        int result = JOptionPane.showConfirmDialog(null, view.getSearchDialog(), "Search", JOptionPane.OK_CANCEL_OPTION,
            JOptionPane.PLAIN_MESSAGE);
        if (result == JOptionPane.OK_OPTION) {
          ...
          case "Tag":
            ...
            case "equal to":
              subImageList = subImageStream.filter(image -> image.getTag().contains(inputValue))
          ...
          case "Author":
            ...
            switch (valueCondition) {
            case "equal to":
              subImageList = subImageStream.filter(image -> image.getAuthor().contains(inputValue))
                  .collect(Collectors.toList());
              updateListLabels(subImageList);
              break;
            case "greater than":
          ...
          case "Date":
            ...
            switch (valueCondition) {
            case "equal to":
              subImageList = subImageStream.filter(image -> image.getDate().contains(inputValue))
                  .collect(Collectors.toList());
              updateListLabels(subImageList);
              break;
            case "greater than":
              subImageList = subImageStream.filter(image -> image.dateGreater(inputValue)).collect(Collectors.toList());
              updateListLabels(subImageList);
              break;
            case "less than":
              subImageList = subImageStream.filter(image -> image.dateLessThen(inputValue))
                  .collect(Collectors.toList());
              updateListLabels(subImageList);
              break;
            case "min value":
          ...
          case "Location":
            ...
            switch (valueCondition) {
            case "equal to":
              subImageList = subImageStream.filter(image -> image.getLocation().contains(inputValue))
                  .collect(Collectors.toList());
              updateListLabels(subImageList);
              break;
            case "greater than":
          ...
          case "Path":
            ...
            switch (valueCondition) {
            case "equal to":
              subImageList = subImageStream.filter(image -> image.getPath().contains(inputValue))
                  .collect(Collectors.toList());
              updateListLabels(subImageList);
              break;
            case "greater than":
